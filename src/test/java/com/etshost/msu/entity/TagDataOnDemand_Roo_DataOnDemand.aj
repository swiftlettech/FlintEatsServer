...
import com.etshost.msu.entity.TagDataOnDemand;
...
privileged aspect TagDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    UserDataOnDemand TagDataOnDemand.userDataOnDemand;
    ...
    public void TagDataOnDemand.setCreated(Tag obj, int index) {
        Instant created = null;
        obj.setCreated(created);
    }
    
    public void TagDataOnDemand.setModified(Tag obj, int index) {
    ...
    public void TagDataOnDemand.setStatus(Tag obj, int index) {
