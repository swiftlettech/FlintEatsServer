			...
			.declare(
					...
					[ dijit._Widget, dijit._Templated ],
					{
						...
						_changeBox : function() {
							...
							if (this.parent.multiple) {
								this.option.selected = this.checkBox
										.attr("value") && true;
							} else {
						...
						_setDisabledAttr : function(_1) {
							...
							dojo.toggleClass(this.domNode,
									"dojoxMultiSelectDisabled", this.disabled);
						},
			...
			.declare(
					...
					dijit.form._FormSelectWidget,
					{
						...
						_addOptionItem : function(_3) {
							this.wrapperDiv
									.appendChild(new dojox.form._CheckedMultiSelectItem(
											{
												option : _3,
												parent : this
											}).domNode);
						...
						_getChildren : function() {
							return dojo.map(this.wrapperDiv.childNodes,
									function(n) {
